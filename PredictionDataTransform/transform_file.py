...
class DataTransform_class:
    ...
    def transform(self):
        self.logger.logs("logs","prediction","entered into the transform method of DataTransform_class")
        ...
        try:
            ...
            self.logger.logs("logs","prediction","Exception occured in transform method of DataTransform_class")
            self.logger.logs("logs","prediction","Exception Message : {}".format(str(e)))
